...
/*
 * Inserts each item of the array at the end of the list.
 * Works even when the list has some elements in it.
 */
...
/*
 * Set the match function separately, if comparisons are needed.
 */
